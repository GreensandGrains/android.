...
async function simulateLoadingWithProgress() {
    return new Promise((resolve) => {
        ...
        let progress = 0;
        const steps = [
            { text: 'Initializing Smart Serve IDE...', progress: 20 },
            { text: 'Loading AI Assistant...', progress: 40 },
            { text: 'Setting up project environment...', progress: 60 },
            { text: 'Preparing code editor...', progress: 80 },
