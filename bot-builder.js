...
function handleSuccessfulLogin(user) {
    ...
    if (userProfileSection) {
        ...
        document.getElementById('profile-avatar-large').src = user.avatar || 'https://via.placeholder.com/80x80/ffffff/000000?text=U';
        document.getElementById('profile-username').textContent = user.username;
        document.getElementById('order-count').textContent = Math.floor(Math.random() * 10);
    }
}
